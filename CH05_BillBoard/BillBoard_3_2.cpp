...
XMMATRIX MakeBillboardMatrix( XMMATRIX *pmatView, XMFLOAT3 *pv3Pos )
{
	...
	// 회전부분의 전치행렬 생성
	matBill._11 = pmatView->_11;
	matBill._12 = pmatView->_21;
	matBill._13 = pmatView->_31;
	matBill._14 = 0.0f;
	matBill._21 = pmatView->_12;
	matBill._22 = pmatView->_22;
	matBill._23 = pmatView->_32;
	matBill._24 = 0.0f;
	matBill._31 = pmatView->_13;
	matBill._32 = pmatView->_23;
	matBill._33 = pmatView->_33;
	matBill._34 = 0.0f;
	matBill._41 = pv3Pos->x;
	matBill._42 = pv3Pos->y;
	matBill._43 = pv3Pos->z;
	matBill._44 = 1.0f;
...
// 빌보드의 Z정렬
int SortBillboard( MY_BILLBOARD *pSource, MY_BILLBOARD **ppSort, int nDataNum, XMMATRIX *pmView )
{
	int i, j;

	for( i = 0; i < nDataNum; i++ )
	{
		pSource[i].fSortKey = pmView->_13 * pSource[i].v3Pos.x + pmView->_23 * pSource[i].v3Pos.y + pmView->_33 * pSource[i].v3Pos.z; // View좌표에서의 z성분
	}
	for( i = 0; i < nDataNum; i++ )
	{
		for( j = i - 1; j >= 0; j-- )
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
	...
	g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "BillBoard_3_2" ), WS_OVERLAPPEDWINDOW, 100, 20, rcRect.right - rcRect.left, rcRect.bottom - rcRect.top, GetDesktopWindow(), NULL,
												 wc.hInstance, NULL );
