...
https://github.com/gilbutITbook/006822 에서 다운로드 받은 "3D 게임을 움직이는 수학과 물리" 도서의 소스 코드를 VC++ 2008 에서 빌드할 수 있도록 솔루션 파일과 프로젝트 파일을 생성하는 프로젝트입니다.

https://github.com/gilbutITbook/006822 에서 다운로드 받은 "3D 게임을 움직이는 수학과 물리" 도서의 소스 코드는 솔루션 파일과 프로젝트 파일이 존재하지 않는 것 같아서 VC++ 2008 에서 빌드할 수 있도록 솔루션 파일과 프로젝트 파일을 생성하는 프로젝트를 시작하였습니다.
