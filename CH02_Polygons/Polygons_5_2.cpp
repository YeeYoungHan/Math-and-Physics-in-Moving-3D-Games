...
int DrawChangingPictures( void )
{
	...
	float fPhi1, fPhi2;
	float fAngleDelta;
	float SrcPoints[DATA_NUM][2] = { { 1.8f, 2.0f },	{ 2.0f, 1.5f },	 { 1.8f, 1.0f },	{ 1.0f, 0.5f },	 { 0.5f, 0.0f }, { 0.2f, -0.5f },
																	 { 0.2f, -1.7f }, { 0.7f, -1.8f }, { 1.4f, -1.9f }, { 1.5f, -2.0f }, { 0.0f, -2.0f } };
	...
	for( i = 0; i < DATA_NUM - 1; i++ )
	{
		...
		for( j = 0; j < CORNER_NUM; j++ )
		{
			...
			Draw3DPolygon( p1.x, p1.y, p1.z, 0xffffff00, p3.x, p3.y, p3.z, 0xffff0000, p2.x, p2.y, p2.z, 0xff00ff00 );
			Draw3DPolygon( p2.x, p2.y, p2.z, 0xff00ffff, p3.x, p3.y, p3.z, 0xffff00ff, p4.x, p4.y, p4.z, 0xff0000ff );
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
	...
	g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "Polygons_5_2" ), WS_OVERLAPPEDWINDOW, 100, 20, rcRect.right - rcRect.left, rcRect.bottom - rcRect.top, GetDesktopWindow(), NULL,
												 wc.hInstance, NULL );
