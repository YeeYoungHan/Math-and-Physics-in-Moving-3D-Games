...
int DrawChangingPictures( void )
{
	...
	float fAngleDelta;
	float SrcPoints[5][2] = { { 0.0f, 2.0f }, { 1.0f, 0.5f }, { 0.5f, 0.5f }, { 0.5f, -2.0f }, { 0.0f, -2.0f } };
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
	...
	g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "Polygons_5_1" ), WS_OVERLAPPEDWINDOW, 100, 20, rcRect.right - rcRect.left, rcRect.bottom - rcRect.top, GetDesktopWindow(), NULL,
												 wc.hInstance, NULL );
