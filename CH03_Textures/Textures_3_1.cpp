...
int DrawChangingPictures( void )
{
	...
	// 정점 인덱스로 그리기
	DrawIndexed3DPolygonsTex( Vertices, ( CORNER_NUM + 1 ) * ( CORNER_NUM / 2 + 1 ), wIndices, CORNER_NUM * CORNER_NUM / 2 * 2 * 3 );
...
HRESULT MakeShaders( void )
{
...
#endif
	// 컴파일
	hr = D3DX11CompileFromFile( _T( "Basic_3D_Light.fx" ), NULL, NULL, "VS", "vs_4_0_level_9_1", dwShaderFlags, 0, NULL, &pVertexShaderBuffer, &pError, NULL );
	if( FAILED( hr ) )
	{
	...
	hr = D3DX11CompileFromFile( _T( "Basic_3D_Light.fx" ), NULL, NULL, "PS", "ps_4_0_level_9_1", dwShaderFlags, 0, NULL, &pPixelShaderBuffer, &pError, NULL );
	if( FAILED( hr ) )
	{
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
	...
	g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "Textures_3_1" ), WS_OVERLAPPEDWINDOW, 100, 20, rcRect.right - rcRect.left, rcRect.bottom - rcRect.top, GetDesktopWindow(), NULL,
												 wc.hInstance, NULL );
